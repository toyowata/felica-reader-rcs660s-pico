...
#ifndef AS289R2_STUB_H
#define AS289R2_STUB_H
...
{
public:
    // Explicitly calling the non-parameter constructor of the base class AS289R2()
    AS289R2_STUB(int txd = 0, int rxd = 0, uart_inst_t* ch = nullptr, uint32_t baud = 9600)
        : AS289R2() {}
